...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('story_code', models.CharField(default='0d1a146bb99f42659d77', editable=False, max_length=20, unique=True)),
                ('title', models.CharField(max_length=500, unique=True)),
                ('slug', models.SlugField(default='djangodbmodelsfieldscharfield', max_length=500, unique=True)),
                ('content', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('prayerrequest_hex', models.CharField(default='5e2e00c7b27b44e99c3f0f', editable=False, max_length=22, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('policy_hex', models.CharField(default='84a9dd77b1484ddabe09', editable=False, max_length=20, unique=True)),
                ('title', models.CharField(max_length=500, unique=True)),
                ('slug', models.SlugField(default='djangodbmodelsfieldscharfield', max_length=500, unique=True)),
                ('content', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('featured_image', models.ImageField(blank=True, help_text='Include a high-quality image in your story to make it more inviting to readers.', null=True, upload_to='policy_photos/%Y/%m/%d/', validators=[accounts.validators.validate_Image_extension])),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateField(auto_now=True)),
                ('restrict_comment', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
