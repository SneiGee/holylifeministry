...
urlpatterns = [
    # -----    CHRISTIANBASE CREDENTIALS (Login, Craete account, Logout) .and more )    -------- #
    ...
    # -----    CHRISTIANBASE STORIES URL.. .and more )
    path('', include('posts.urls')),

    # -----    CHRISTIANBASE Ckeditor default URL.. .and more )
    ...
    # -----    CHRISTIANBASE CREDENTIALS_ACTIVATION ( Activate account, Resend activation link .and more )    -------- #
    ...
    # -----    CHRISTIANBASE ACCOUNT LOCKED ( Recover Account, Account Lock .and more )    -------- #
    ...
    # -----    CHRISTIANBASE CHANGE PASSWORD ( Password change .and more )    -------- #
    path('<str:username>/password-change/', views.ChristianBasePasswordChangeView.as_view(), name='password_change'),
    # -----    CHRISTIANBASE PASSWORD RESET ( Password Reset, Password Done .and more )    -------- #
    ...
    # -----    CHRISTIANBASE USER_ACCOUNT ( Profile, Update Profile, Upload Profile .and more )    -------- #
    ...
    # -----    CHRISTIANBASE Report User ( User Report Option .and more )    -------- #
    ...
    # -----    CHRISTIANBASE SETTINGST ( Setting, Delete Account .and more )    -------- #
