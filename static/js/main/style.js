...
jQuery(document).ready(function($) {
    ...
    if($(window).width() < 769) {
        jQuery(".archive-post-area").children().removeClass("footer-sidebar-area");
    }

    if ($.isFunction($.fn.stick_in_parent)) {
        $('.footer-sidebar-area').stick_in_parent({
            parent: '.archive-post-area',
            offset_top: 30,
        });


        $('.footer-sidebar').stick_in_parent({
            parent: 'body',
            offset_top: 0,
        });
